class home extends HTMLElement {
    connectedCallback() {
        this.innerHTML=`
        <section class="home d-flex light align-items-center">
			<div class="container">

				<!-- intro -->
				<div class="intro">
					<img class="img-fluid rounded" src="/images/doted_ram.png" width="50%" alt="Ram" class="mb-4" />

					<!-- info -->
					<h1 class="mb-2 mt-0">Ram Swami</h1>
					<span>I'm a <span class="text-rotating">Full Stack Developer, Cloud Developer, WordPress
							Developer</span></span>

					<!-- social icons -->
					<ul class="social-icons light list-inline mb-0 mt-4">
						<li class="list-inline-item"><a href="https://www.linkedin.com/in/ramswami0021/"
								target="_blank"><i class="fab fa-linkedin"></i></a></li>
						<li class="list-inline-item"><a href="https://www.instagram.com/ramswami_0021/"
								target="_blank"><i class="fab fa-instagram"></i></a></li>
						<li class="list-inline-item"><a href="https://github.com/RamSwami0021" target="_blank"><i
									class="fab fa-github"></i></a></li>
						<li class="list-inline-item"><a href="mailto:ramswami0021@gmail.com" target="_blank"><i
				...
				<div class="parallax" data-relative-input="true">
					...
					<svg width="35" height="23" data-depth="0.6" class="layer p4" xmlns="http://www.w3.org/2000/svg">
						<rect transform="rotate(30 9.86603 10.13397)" x="7" width="3" height="25" rx="1.5"
							fill="#FFD15C" fill-rule="evenodd" />
					</svg>

					<svg width="35" height="23" data-depth="0.2" class="layer p5" xmlns="http://www.w3.org/2000/svg">
						<rect transform="rotate(30 9.86603 10.13397)" x="7" width="3" height="25" rx="1.5"
